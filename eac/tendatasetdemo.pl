...
system('stdvar_milligan_cooper1988 -i iris.data -a "1-4" -c 5 -h yes --std-var Z5 > iris_z5.data');
...
insertheader($file,$header);
print "Download $file OK\n";
system('stdvar_milligan_cooper1988 -i wine.data -a "2-13" -c 1 -h yes --std-var Z5 > wine_z5.data');
print "Stdvar $file OK\n";
...
insertheader($file,$header);
print "Download $file OK\n";
system('stdvar_milligan_cooper1988 -i glass.data -a "2-10" -c 11 -h yes --std-var Z5 > glass_z5.data');
print "Stdvar $file OK\n";
...
$file = 'SPECTF.test';
getstore($url, $file);
copy "SPECTF.train", "spectf.data"; # or die "Copy failed: $!";
open FILEA, '>> spectf.data' or die $!;
open FILEB, '< SPECTF.test' or die $!;
print FILEA <FILEB>;
insertheader('spectf.data',$header);
print "Download $file OK\n";
system('stdvar_milligan_cooper1988 -i spectf.data -a "2-23" -c 1 -h yes --std-var Z5 > spectf_z5.data');
print "Stdvar $file OK\n";
system("Rscript kfold.R spectf_z5.data");
print "k-fold $file OK\n";
...
insertheader($file,$header);
print "Download $file OK\n";
system('stdvar_milligan_cooper1988 -i haberman.data -a "1-3" -c 4 -h yes --std-var Z5 > haberman_z5.data');
print "Stdvar $file OK\n";
...
insertheader($file,$header);
print "Download $file OK\n";
system('stdvar_milligan_cooper1988 -i ecoli.data -d " " -a "2-8" -c 9 -h yes --std-var Z5 > ecoli_z5.data');
print "Stdvar $file OK\n";
...
insertheader($file,$header);
print "Download $file OK\n";
system('stdvar_milligan_cooper1988 -i ionosphere.data -a "1,3-34" -c 35 -h yes --std-var Z5 > ionosphere_z5.data');
print "Stdvar $file OK\n";
...
print "Download $file OK\n";
system('stdvar_milligan_cooper1988 -i hayes_roth.data -a "3-5" -c 6 -h yes --std-var Z5 > hayes_roth_z5.data');
print "Stdvar $file OK\n";
...
insertheader($file,$header);
print "Download $file OK\n";
system('stdvar_milligan_cooper1988 -i zoo.data -a "2-17" -c 18 -h yes --std-var Z5 > zoo_z5.data');
print "Stdvar $file OK\n";
